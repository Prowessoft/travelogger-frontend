        ...
        <div className="prose prose-lg">
          ...
          <section className="mb-12">
            ...
            <ul className="list-disc pl-6 text-gray-600 mb-6">
              ...
              <li>Contains harmful software or malicious code</li>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">5. Travel Planning Services</h2>
            <p className="text-gray-600 mb-4">Our travel planning services, including AI-powered recommendations, are provided "as is" and:</p>
            <ul className="list-disc pl-6 text-gray-600 mb-6">
              <li>Should be used as suggestions only and verified independently</li>
              <li>May not be suitable for all travelers or circumstances</li>
              <li>Are subject to availability and accuracy of third-party information</li>
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-600 mb-4">When using our community features, you agree to:</p>
            <ul className="list-disc pl-6 text-gray-600 mb-6">
              ...
              <li>Not spam or post promotional content without authorization</li>
          ...
          <section className="mb-12">
            ...
            <ul className="list-disc pl-6 text-gray-600 mb-6">
              ...
              <li>Travel-related incidents or accidents</li>
